...
//     <div class="p-5">
//         <a href="#">
//             <h5 class="mb-2 text-2xl font-bold tracking-tight text-brightGreen">{service.title}</h5>
//         </a>
//         <p class="mb-3 font-normal text-gray-00 dark:text-slate-600">{service.description}.</p>
//         <a href="#" class="inline-flex items-center py-2 text-sm font-bold text-center text-brightGreen focus:outline-none">
//             Read more
//              <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
//                 <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
//             </svg>
